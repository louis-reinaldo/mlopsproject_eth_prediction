...
def test_data_preparation(
    mock_save_data, mock_split_data, mock_create_features, mock_load_data
):
...
def test_load_model():
    ...
    ), "The loaded model is not of the correct type"
    ...
    assert (
        predictions.shape == y_train.shape
    ), "The model's predictions are not the expected shape"
